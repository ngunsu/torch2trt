...
@add_module_test(torch.float32, torch.device('cuda'), [(1, 10, 10, 224, 224)])
...
@add_module_test(torch.half, torch.device('cuda'), [(1, 10, 10, 224, 224)])
def test_Conv3d_dilation2_half():
    return torch.nn.Conv3d(10, 5, kernel_size=3, stride=1, padding=1, dilation=2)
